...
{
	public partial class BancoMAP_TB_LOGIN_GROUPItem : GeneralDataProviderItem
	{
		...
		public BancoMAP_TB_LOGIN_GROUPItem(string DataBaseName) : this(DataBaseName, true)
		{
		}

		public BancoMAP_TB_LOGIN_GROUPItem(string DataBaseName, params string[] FieldNames) : this(DataBaseName, false, FieldNames)
		{
		}
		...
		/// </summary>
		private BancoMAP_TB_LOGIN_GROUPItem(string DataBaseName, bool AllFields, params string[] FieldNames)
		{
	...
	/// </summary>
	public class BancoMAP_TB_LOGIN_GROUPDataProvider : GeneralDataProvider
	{
		...
		{
			return BancoMAP_TB_LOGIN_GROUPItem.CreateItemFields(true); 
		}
		...
		{
			return this.GetFilterExpression( BancoMAP_TB_LOGIN_GROUPItem.CreateItemFields(false, GetUniqueKeyFields()));
		}
